...
# [:] is a slice notation that copies the list and pairs it with the new variable
...
print(my_foods)
print(friends_foods)
# We cannot use an = to make a new list, as an = will establish both lists as a constant, meaning they will both permanently contain the same items
